...
print(f"Starting training for Mixed...")
result = train_cluster('Mixed', features, gpu_id=0)
...
with open('result_Mixed.json', 'w') as f:
    json.dump(result_data, f)

print(f"✓ Mixed complete! Time: {result['training_time']/60:.1f} min")
