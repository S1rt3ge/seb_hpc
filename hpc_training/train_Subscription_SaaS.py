...
print(f"Cluster: Subscription_SaaS, GPU: 3")
...
print(f"Starting training for Subscription_SaaS...")
result = train_cluster('Subscription_SaaS', features, gpu_id=0)
...
with open('result_Subscription_SaaS.json', 'w') as f:
    json.dump(result_data, f)

print(f"✓ Subscription_SaaS complete! Time: {result['training_time']/60:.1f} min")
